...
const MapComponent: React.FC<MapComponentProps> = ({ layerTrigger }) => {
    ...
    useEffect(() => {
        ...
        const attemptInitialization = () => {
            ...
            // Solo inicializa cuando el layout ya resolvió dimensiones útiles
            if (offsetWidth > 0 && offsetHeight > 0) {
                ...
                // Desconectamos el observador una vez que el mapa se ha asegurado
                if (resizeObserver) {
        ...
        if (mapDiv.current) {
            resizeObserver = new ResizeObserver(() => {
                ...
                // Debounce de 300ms garantizando un layout estable antes de instanciar ArcGIS
    ...
    return (
        // El contenedor asume flex 1 heredando la altura del árbol CSS corregido en App.css
        <div className="map-component-root" style={{ display: 'flex', flexDirection: 'column', flex: 1, position: 'relative' }}>
            
            {/* Div del mapa limpio. Depende de Flexbox para llenar el área útil.
                Sin colores rojos ni pixeles quemados. */}
